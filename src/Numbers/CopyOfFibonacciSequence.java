...
/**
 * @author Jess This program takes an input from the user that can be any digit,
 *         and prints the fibonacci sequence up to that number.
 *
 */
public class CopyOfFibonacciSequence {
